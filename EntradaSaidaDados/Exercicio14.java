...
public class Exercicio14 {
	...
	public static void main (String args[]) {
		...
		//Dicas
		//Primeiro passe velocidade de conecção(velocidade de internet) para bytes dividindo por 8
		// Depois Divida o tamanho do arquivo pela velocidade de conecção em bytes.
